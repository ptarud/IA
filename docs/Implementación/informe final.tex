...
%Si bien el algoritmo \emph{Hill Climbing} busca mejorar las soluciones, permitiré al algoritmo al momento de reiniciarse partir de una solución peor que la actual, con el fin
...
%Los experimientos se hicieron con las instancias propuestas en la presentación del problema. \\

%En la siguiente tabla se muestran las instancias que se usaron, con cada uno de los parámetros.  \\
 
%\begin{tabular}{| l | l | l | l | l | l | l | l | l |}
%\hline
%\textbf{Instancia} & \textbf{N} &\textbf{K} & \textbf{L} & \textbf{U} & \textbf{B} & \textbf{O} & Iteraciones & \textbf{maxIters} \\ \hline
%data4.txt & 4 & 0 & 1 & 3 & 3 & 4 & 20\\ \hline
%data4.txt & 4 & 1 & 1 & 3 & 3 & 4 & 20\\ \hline
%data4.txt & 4 & 2 & 1 & 3 & 3 & 4 & 20\\ \hline
%data6.txt & 6 & 0 & 1 & 3 & 3 & 4 & 20\\ \hline
%data6.txt & 6 & 1 & 1 & 3 & 3 & 4 & 20\\ \hline
%data6.txt & 6 & 2 & 1 & 3 & 3 & 4 & 20\\ \hline
%data8.txt & 8 & 0 & 1 & 3 & 3 & 4 & 20\\ \hline
%data8.txt & 8 & 1 & 1 & 3 & 3 & 4 & 20\\ \hline
%data8.txt & 8 & 2 & 1 & 3 & 3 & 4 & 20\\ \hline
%data10.txt & 10 & 0 & 1 & 3 & 3 & 4 & 20 \\ \hline
%data10.txt & 10 & 1 & 1 & 3 & 3 & 4 & 20\\ \hline
%data10.txt & 10 & 2 & 1 & 3 & 3 & 4 & 20\\ \hline
%\end{tabular}
%\\

%Si bien el algoritmo no posee parámetros que regulen la capacidad del algoritmo de explotar o explorar, es por eso que se definió el parámetro \textbf{maxIters}, dicho parámetro le da la capacidad al algoritmo de explorar, ya que 
%luego de \textbf{maxIters} iteraciones en el que el algoritmo está estancado en un óptimo local, el algoritmo se reinicia, es decir comienza desde una nueva solución inicial. \\

%Como se dijo anteriormente, usaré tres diferentes restarts. Si bien \emph{Hill Climbing} va buscando una mejor solución cada vez que itera, permitiré al algoritmo reiniciarse sobre un estado anterior que haya sido peor que alguna solución inicial, 
%con el fin de que el algoritmo pueda explorar más, ya que por ejemplo, puede que al lado de una solución muy mala dentro de el espacio de búsqueda esté una muy buena y si parto desde ahí Hill Climbing encontrará dicha buena solución. 
